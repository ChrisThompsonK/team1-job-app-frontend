...
This project uses **Biome** for linting and formatting. All code generated by Copilot MUST comply with the Biome configuration defined in `config/biome.json`. Below are the specific rules and standards to follow:
